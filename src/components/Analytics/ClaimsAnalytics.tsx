...
import { FiBarChart, FiPieChart, FiTrendingUp, FiDollarSign, FiClock, FiTarget, FiX, FiActivity } from "react-icons/fi";
import type { ClaimsAnalyticsData } from "@/types/insurance";
import { toEthStr, tsToDateStr, celoscanBase, celoscanAddress, fmt, toTokenStr } from "@/utils/web3";

type Props = { data: ClaimsAnalyticsData; loading: boolean };
...
const getColorForStatus = (s: string) => COLORS[s] ?? "#6b7280";
      ...
      <div className="relative bg-white/80 backdrop-blur-xl border border-white/50 shadow-xl rounded-2xl p-8">
        ...
        <div className="relative">
          <div className="flex items-center space-x-4 mb-8">
            ...
            <h3 className="text-2xl font-bold text-gray-900">Claims Analytics</h3>
          </div>
    ...
    <div className="relative bg-white/80 backdrop-blur-xl border border-white/50 shadow-xl rounded-2xl p-8">
      <div className="relative">
        ...
        <div className="flex items-center space-x-4 mb-8">
          ...
          <div>
            <h3 className="text-2xl font-bold text-gray-900">Claims Analytics</h3>
            <p className="text-gray-600">Comprehensive insights into your claims data</p>
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white/60 backdrop-blur-sm border border-white/50 rounded-2xl p-6">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <h4 className="text-xl font-bold text-gray-900">Claims Status Distribution</h4>
            </div>
            ...
            {statusData.length ? (
                  ...
                  <PieChart>
                    ...
                    >
                      {statusData.map((entry, idx) => (
                        <Cell key={`cell-${idx}`} fill={getColorForStatus(entry.name)} />
                      ))}
                    </Pie>
              ...
              <div className="h-80 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-500 font-medium">No claims data available</p>
                </div>
              </div>
            )}
          </div>
          ...
          {monthlyData.length > 0 && (
            <div className="bg-white/60 backdrop-blur-sm border border-white/50 rounded-2xl p-6">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h4 className="text-xl font-bold text-gray-900">Monthly Claims Trend</h4>
              </div>
            ...
            <div className="relative bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-200 rounded-2xl p-6 group hover:shadow-xl transition-all duration-300">
              <div className="relative flex items-center space-x-4">
                ...
                <div>
                  ...
                  <div className="text-sm font-medium text-blue-600">Average Claim Amount</div>
                </div>
              </div>
            </div>
            ...
            <div className="relative bg-gradient-to-br from-emerald-50 to-green-50 border border-emerald-200 rounded-2xl p-6 group hover:shadow-xl transition-all duration-300">
              <div className="relative flex items-center space-x-4">
                ...
                <div>
                  ...
                  <div className="text-sm font-medium text-emerald-600">Avg Processing Time</div>
                </div>
              </div>
            </div>
          </div>

          {/* total value + status chips */}
          <div className="relative bg-gradient-to-br from-purple-50 to-pink-50 border-2 border-purple-200 rounded-2xl p-8 overflow-hidden">
            <div className="relative text-center">
              ...
              <div className="text-lg font-semibold text-purple-600">Total Claims Value</div>
              <p className="text-purple-500 mt-2">Cumulative value of all processed claims</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {Object.entries(data.statusDistribution || {}).map(([status, count]) => {
              ...
              const Icon = map[status] ?? FiActivity;
