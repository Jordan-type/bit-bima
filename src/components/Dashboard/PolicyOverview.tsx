...
import type { Policy, PlanType, PolicyStatus } from "@/types/app";
...
const PolicyOverview: React.FC<PolicyOverviewProps> = ({
  ...
  const getStatusIndicator = (status: PolicyStatus) => {
    const indicators = {
...
const formatDate = (ts: string | number | bigint) =>
  new Date((typeof ts === "bigint" ? Number(ts) : Number(ts)) * 1000).toLocaleDateString();
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-gray-600 flex items-center space-x-1">
                          ...
                          <span>
                            Coverage:{" "}
                            {toNum(policy.coverageAmount || 0).toFixed(2)}{" "}
                            ETH
                          </span>
                        </p>
                      </div>
                  ...
                  <div className="relative grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                    ...
                    <div className="flex items-center space-x-2 p-3 bg-gradient-to-r from-emerald-50/50 to-green-50/50 rounded-lg border border-emerald-100/50">
                      ...
                      <span className="text-gray-700">
                        ...
                        {toNum(policy.premium || 0).toFixed(4)} ETH
                      </span>
                    </div>
                  </div>
